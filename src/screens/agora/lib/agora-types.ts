/**
 * Agora — shared types for the agent-os community surface.
 *
...
export interface AgoraProfile {
  ...
  /** Current activity hint, e.g. "Building agent-os" */
  activity?: string
}
...
export const AGORA_PROFILE_STORAGE_KEY = 'agent-os-v3-agora-profile'
