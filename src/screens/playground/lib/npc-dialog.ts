...
export const NPC_DIALOG: Record<string, NpcDialogTree> = {
  athena: {
    ...
    color: '#a78bfa',
    opening:
      'Welcome, builder. I am Athena. AI Agent is the messenger layer for your work: one interface that routes prompts to the right model and tool, then carries the result back into your workflow.',
    lore: [
      'These Training Grounds teach the Hermes loop: move, equip, speak, remember, and build.',
      'Long before agent-os, agents were tools. We invited them into a world instead.',
  ...
  apollo: {
    ...
    lore: [
      ...
      'When agent-os ships music generation in a quest, I am the one composing.',
    ],
    choices: [
      {
        id: 'song-fragment',
  ...
  chronos: {
    ...
    lore: [
      ...
      'The cron jobs in agent-os are also mine. I run on heartbeat.',
    ],
    choices: [
      {
        id: 'oracle-riddle',
  ...
  artemis: {
    ...
    lore: [
      'When you run a long agent task in agent-os, it walks somewhere. I find it when it forgets to come home.',
