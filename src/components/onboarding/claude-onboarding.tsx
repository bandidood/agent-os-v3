      ...
      if (data.capabilities?.chatCompletions) {
        ...
        setBackendMessage(
          data.capabilities.sessions
            ? 'Backend connected. Core chat works, and AI Agent gateway enhancements are available.'
        ...
        >
          {step === 'welcome' && (
            <div className="space-y-4 text-center">
              ...
              <p className="text-sm" style={mutedStyle}>
                Works with any OpenAI-compatible backend. AI Agent gateway APIs
          ...
          {step === 'connect' && (
            <div className="space-y-4 text-center">
              ...
              <p className="text-sm" style={mutedStyle}>
                Start by verifying that agent-os can reach your
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <p className="mt-2" style={mutedStyle}>
                      ...
                      <code>/v1/chat/completions</code>. If you point AI Agent
                      Workspace at a AI Agent gateway, enhanced features unlock
                      automatically.
                    </p>
                    <div
            ...
            <div className="space-y-4">
              ...
              <p className="text-center text-xs" style={mutedStyle}>
                {canEditConfig
                  ...
                  : 'This backend manages provider settings outside agent-os. Confirm the model you expect to use, then test chat.'}
              </p>
          ...
          {step === 'test' && (
            <div className="space-y-4 text-center">
              ...
              <p className="text-sm" style={mutedStyle}>
                Verify that core chat works first. Enhanced AI Agent features are
            ...
            <div className="space-y-4 text-center">
              ...
              <p className="text-sm" style={mutedStyle}>
                ...
                {enhancedFeatures.length > 0
                  ? 'This backend also exposes AI Agent gateway enhancements.'
                  : 'If you later connect a AI Agent gateway, enhanced features unlock automatically.'}
              </p>
              <div
